# Contributing to qcom-build-utils
...
1. [Fork](https://github.com/qualcomm-linux/qcom-build-utils/fork) and clone the repository.
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/qcom-build-utils.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/qcom-build-utils/pulls) from your branch to `main`.
